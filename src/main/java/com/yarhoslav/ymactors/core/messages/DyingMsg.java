 ...
 * @author YarhoslavME
 */
public final class DyingMsg implements IActorMsg {
    
    private final String ID = "DYINGMSG";
    private static final DyingMsg SINGLETON = new DyingMsg();
    
    public static DyingMsg getInstance() {
        return SINGLETON;
    }  
